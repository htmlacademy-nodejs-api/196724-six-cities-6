...
import { OFFER_NAME_MIN, OFFER_NAME_MAX, OFFER_DESC_MAX, OFFER_DESC_MIN, OFFER_PRICE_MAX, OFFER_PRICE_MIN, OFFER_BEDROOMS_MAX, OFFER_BEDROOMS_MIN, OFFER_GUESTS_MAX, OFFER_GUESTS_MIN } from './offer-validator-constraints.constants.js';
